...
describe('Messages utility functions', () => {
  ...
  afterAll(() => {
    getRandomElementSpy.mockRestore();
  });

  describe('getRandomInputUrlMessage', () => {
    it('returns a message from the SHORT_INPUT_URL_MESSAGES array when the URL is less than 45 characters in length', () => {
    ...
    it('returns a message from the LONG_INPUT_URL_MESSAGES array when the URL is less than 45 characters in length', () => {
      const url =
  ...
  describe('getRandomOutputUrlMessage', () => {
    it('returns a message from OUTPUT_URL_MESSAGES array', () => {
