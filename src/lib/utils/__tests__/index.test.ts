...
describe('General utility functions', () => {
  describe('md5Hash', () => {
    ...
    afterAll(() => {
      mockHashDigestFn.mockRestore();
      mockHashUpdateFn.mockRestore();
      createHashSpy.mockRestore();
    });

    it('creates an MD5 hash from an input and returns the value in hexadecimal format', () => {
  ...
  describe('getRandomElement', () => {
    it('returns a random element from the provided array', () => {
